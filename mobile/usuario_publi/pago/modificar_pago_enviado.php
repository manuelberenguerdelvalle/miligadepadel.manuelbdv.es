...
$consulta = $db->consulta("SELECT * FROM pago_web WHERE usuario = '$id_usuario_publi' AND bd = 'ligas' AND tipo = 'P' AND estado = 'E' ORDER BY pagado,fecha; ");
	...
	<div class="caja"> 
        ...
        <div class="datos2">
            <label class="datos_linea">
				...
				echo '<b>Fin Suscripci&oacute;n:</b> ';
				if($resultados['pagado'] == 'S'){
		...
		?>
        <div class="datos4">
        	<?php muestra_formulario(utf8_encode($descrip_pago),$resultados['id_pago_web'],$resultados['precio'],'http://miligadepadel.manuelbdv.es/mobile/usuario_publi/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/mobile/ep/pw.php',cuenta_admin()); 		
			?>
        </div>
        <?php
		}
