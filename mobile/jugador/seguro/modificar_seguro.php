...
<div class="columna1">
    ...
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Introduce la comunidad aut&oacute;noma.');" onMouseOut="hiddenDiv()" style="display:table;">Federacion:</div>
...
<div class="columna3">
    ...
    <div class="cuadroComentario"><span id="categoriaCom">* Introduzca la categora correctamente.</span></div>
    <div class="cuadroComentario"><span id="federacionCom">* Introduzca la federacin correctamente.</span></div>
