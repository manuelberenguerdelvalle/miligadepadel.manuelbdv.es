...
$consulta = $db->consulta("SELECT id_disputa,disputa.fecha,jugador,respuesta,texto,id_partido,jornada,local,visitante,set1_local,set2_local,set3_local,set4_local,set5_local,set1_visitante,set2_visitante,set3_visitante,set4_visitante,set5_visitante,estado FROM partido,disputa WHERE disputa.division = '$id_division' AND id_partido = partido; ");
...
?>
        ...
        <div class="datos">
        	<label class="datos_jornada">Jornada <?php echo $resultados['jornada']; ?></label>
            <label class="datos_estado">Estado: <?php echo obten_estadoPartido($resultados['estado']); ?></label>
            <textarea readonly rows="4" cols="37" disabled><?php echo $resultados['texto']; ?></textarea>
        </div>
        <div class="respuesta">
        	<div class="contestacion"><img src="../../../images/<?php echo $imagen.'.png';?>"><label><?php echo $mensaje;?></label></div>
            <div class="destinatarios">
            	<label><input type="checkbox" id="1_<?php echo $resultados['id_disputa']; ?>" value="<?php echo $id_l_j1; ?>" class="check"><?php echo $l_j1; ?></label>
                <label><input type="checkbox" id="2_<?php echo $resultados['id_disputa']; ?>" value="<?php echo $id_l_j2; ?>" class="check"><?php echo $l_j2; ?></label>
                <label><input type="checkbox" id="3_<?php echo $resultados['id_disputa']; ?>" value="<?php echo $id_v_j1; ?>" class="check"><?php echo $v_j1; ?></label>
                <label><input type="checkbox" id="4_<?php echo $resultados['id_disputa']; ?>" value="<?php echo $id_v_j2; ?>" class="check"><?php echo $v_j2; ?></label>
