...
<div class="horizontal">&nbsp;</div>
<div class="columna1">
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Este es el precio que cada jugador deber abonar para participar en esta divisi&oacute;n/liga.');" onMouseOut="hiddenDiv()" style="display:table;">Inscripcion(&euro;):</div>
    <!--<div class="cuadroTexto" onMouseOver="showdiv(event,'Esta fecha es la que indica el comienzo de las inscripciones de los jugadores para esta divisin/liga. Si no quieres activarla ahora djala en blanco.');" onMouseOut="hiddenDiv()" style='display:table;'>Fecha fin:</div>-->
...
<div class="columna2">
    ...
    <span class="cuadroInputs"><input type="text" name="primero" id="primero" class="input_text" onKeyPress="return letrasYnum(event)" onBlur="limpiaLetrasYnum('primero',2)" maxlength="50" ></span>
    <span class="cuadroInputs"><input type="text" name="segundo" id="segundo" class="input_text" onKeyPress="return letrasYnum(event)" onBlur="limpiaLetrasYnum('segundo',3)" maxlength="50" ></span>
    <span class="cuadroInputs"><input type="text" name="tercero" id="tercero" class="input_text" onKeyPress="return letrasYnum(event)" onBlur="limpiaLetrasYnum('tercero',4)" maxlength="50" ></span>
    <span class="cuadroInputs"><input type="text" name="cuarto" id="cuarto" class="input_text" onKeyPress="return letrasYnum(event)" onBlur="limpiaLetrasYnum('cuarto',5)" maxlength="50" ></span>
    <span class="cuadroInputs"><input type="text" name="quinto" id="quinto" class="input_text" onKeyPress="return letrasYnum(event)" onBlur="limpiaLetrasYnum('quinto',6)" maxlength="50" ></span>
    <span class="cuadroInputs"><input type="text" name="todos" id="todos" class="input_text" onKeyPress="return letrasYnum(event)" onBlur="limpiaLetrasYnum('todos',7)" maxlength="100" ></span>
...
<?php
	...
	echo '<div class="cuadroError">'.utf8_encode('Esta liga tiene el plan gratuito y no es posible a&ntilde;adir m&aacute;s divisiones').'</div>';
}
?>