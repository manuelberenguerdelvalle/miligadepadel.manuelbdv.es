...
<div class="caja1">
    <div class="columna1">
		...
		?>
        <div class="cuadroTexto" onMouseOver="showdiv(event,'La contrase&ntilde;a se utilizar&aacute; para que los jugadores puedan inscribirse primero y desp&uacute;es para acceder a tu liga si la visiblidad es privada.');" onMouseOut="hiddenDiv()" style='display:table;'>Contrase&ntilde;a:</div>
