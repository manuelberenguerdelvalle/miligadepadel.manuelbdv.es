...
if($tipo_pago > 0){
	...
	<div class="caja"> 
        ...
        <div class="datos3">
        	<?php
					//muestra_formulario($descrip_pago,$resultados['id_pago_web'],0.50,'http://miligadepadel.manuelbdv.es/mobile/usuario/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/mobile/recibir_pagos/pago_web.php',cuenta_admin()); 
				muestra_formulario(utf8_encode($descrip_pago),$resultados['id_pago_web'],$resultados['precio'],'http://miligadepadel.manuelbdv.es/mobile/usuario/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/mobile/recibir_pagos/pago_web.php',cuenta_admin()); 
				//muestra_formulario($descrip_pago,$resultados['id_pago_web'],$resultados['precio'],'http://miligadepadel.manuelbdv.es/mobile/usuario/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/mobile/ep/pw.php','manu_oamuf-facilitator@hotmail.com');  
			//muestra_formulario($descrip_pago,$resultados['id_pago_web'].rand(),$resultados['precio'],'http://miligadepadel.manuelbdv.es/mobile/usuario/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/mobile/recibir_pagos/pago_web.php','manu_oamuf-facilitator@hotmail.com');
			 ?>
		...
		?>
        <div class="datos3">
        	<a href="factura.php?id_pago_web=<?php echo $resultados['id_pago_web'];?>&estado=normal" target="_parent" class="boton">&nbsp;&nbsp;Ver Factura&nbsp;&nbsp;</a>
