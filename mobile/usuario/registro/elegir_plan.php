...
<div class="principal">
	<div id="content_popup">
		...
		<div class="popcentro">
			<form id="formulario_contacto" action="#" method="post" name="formulario_contacto" >
				...
				<label class="caja_texto">Mensaje:</label><label class="caja_input_area"><textarea  rows="3" cols="17" name="mensaje" class="input_text_area" ></textarea></label><label id="errorTextarea" class="caja_error">*</label>
    ...
    <div class="contenido">
        ...
        <div class="div1">
            ...
            <div class="divs">
                <div class="texto1">Pack<BR>Gratuito<br><span>Gesti&oacute;n completa<br>para tu liga<span></div>
            ...
            <div class="divs">
                <div class="texto1">Pack<BR>Premium<br><span>Pack gratuito <br />y Servicios++ <a href="#" onclick="swal('Gestiones Premium','<?php echo htmlentities($mensaje_prof);?>');">mas info</a></span></div>
                <div class="precio">
            ...
            <div class="divs">
                <div class="texto1">Clon<BR>Padel<br><span>Gesti&oacute;n ilimitada<br>para tu liga <a href="#" onclick="swal('Gesti&oacute;n Premium Exclusiva','<?php echo htmlentities($mensaje_clon);?>');">mas info</a></span></div>
                <div class="precio">Solicitar Info</div>
        ...
        <div class="div2">
            ...
            <div class="disponible"><span><b><!--<input type="text" class="num_partidos" id="partidos" readonly="readonly" value="10" />-->20 M&aacute;ximo/<br />divisi&oacute;n</b></span></div>
            <div class="disponible"><span><b>20 M&aacute;ximo/<br />divisi&oacute;n</b></span></div>
        </div>
        <div class="div2">
            <div class="propiedad"><span class="alinear">Divisiones&nbsp;&nbsp;</span></div>
            <div class="disponible"><span><b>1 M&aacute;xima</span></b></div>
            <div class="disponible"><span><b>1 gratis + 5 &euro;/<br />divisi&oacute;n extra</b></span></div>
