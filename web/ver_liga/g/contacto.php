...
<?php } ?>
        ...
        <div class="contenido">
            ...
            <div class="contenedor_datos">
                ...
                <label class="caja_input_area2"><textarea  rows="11" cols="50" name="mensaje" id="mensaje" class="input_text_area" onKeyPress="return tecla_direccion(event)" onBlur="limpiaDireccion('mensaje',2,1)"  ></textarea></label>
