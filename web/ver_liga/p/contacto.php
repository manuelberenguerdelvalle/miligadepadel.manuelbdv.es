...
<div class="principal">
	...
	<div id="content_popup">
		...
		<form id="formulario_contacto" action="#" method="post" name="formulario_contacto" >
            ...
            <label class="caja_texto">Mensaje:</label><label class="caja_input_area"><textarea  rows="9" cols="30" name="mensaje" class="input_text_area" ></textarea></label><label id="errorTextarea" class="caja_error">*</label>
    ...
    <div class="central">
    	<div class="cabecera">
    		...
    		<div class="superior">
        		<div class="nombre"><?php echo  '<div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$_SESSION["nombre"].' - Divisi&oacute;n&nbsp;</div>'.generar_input_divs($_SESSION['id_liga'],$_SESSION['id_division'],'contacto.php');?></div>
...
<?php } ?>
        ...
        <div class="contenido">
            ...
            <div class="contenedor_datos">
                ...
                <label class="caja_input_area2"><textarea  rows="11" cols="45" name="mensaje" id="mensaje" class="input_text_area2" onKeyPress="return tecla_direccion(event)" onBlur="limpiaDireccion('mensaje',2,1)"  ></textarea></label>
