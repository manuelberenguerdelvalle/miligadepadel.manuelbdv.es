		...
		?>
        	...
        	<?php
				if($resultados['modo_pago'] == 'P'){//si el modo de pago es online
					...
					//muestra_formulario($descrip_pago,$resultados['id_pago_admin'],0.5,'http://miligadepadel.manuelbdv.es/web/jugador/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/web/ep/pa.php',$resultados['receptor']);
					muestra_formulario($descrip_pago,$resultados['id_pago_admin'],$resultados['precio'],'http://miligadepadel.manuelbdv.es/web/jugador/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/web/ep/pa.php',$resultados['receptor']);
					//muestra_formulario($descrip_pago,$resultados['id_pago_admin'],$resultados['precio'],'http://miligadepadel.manuelbdv.es/web/jugador/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/web/ep/pa.php','manu_oamuf-facilitator@hotmail.com');
				}//fin pago online
				else{
