...
<div class="horizontal">Ver/Modificar Divisi&oacute;n</div>
<div class="horizontal">&nbsp;</div>
<div class="horizontal"><div><b>Importante:</b>Revisa que toda la configuraci&oacute;n de la Liga y Divisi&oacute;n es correcta antes de establecer una fecha de inicio para inscripciones.</div></div>
<div class="horizontal">&nbsp;</div>
<div class="columna1">
<?php if($tipo_pago > 0){
    echo '<div class="cuadroTexto" onMouseOver="showdiv(event,'."'Este es el precio que cada jugador deber abonar para participar en esta divisi&oacute;n/liga.'".');" onMouseOut="hiddenDiv()" style="display:table;">Precio de Inscripci&oacute;n (&euro;):</div>';
	} ?>
    <div class="cuadroTexto" onMouseOver="showdiv(event,'Esta fecha es la que indica cuando pueden comenzar las inscripciones de los jugadores para esta divisi&oacute;n/liga. Si no quieres activarla ahora d&eacute;jala en blanco.');" onMouseOut="hiddenDiv()" style='display:table;'>Fecha de fin de Inscripciones:</div>
...
<div class="columna3">
<?php if($tipo_pago > 0){
	echo '<div class="cuadroComentario"><span id="precioCom">* Introduzca el precio de suscripcin.</span></div>';
	} ?>
...
<?php
if($tipo_pago > 0 && $division->getValor('num_division') != 1){//ligas de pago y numero de division diferente a 1
