...
if($modo == 'email'){//enviar e-mail
	...
	$linksi = 'http://miligadepadel.manuelbdv.es/web/v/v/valida_respuesta_elim.php?id='.genera_id_url(100,$id['id'].'SF',13);
	$linkno = 'http://miligadepadel.manuelbdv.es/web/v/v/valida_respuesta_elim.php?id='.genera_id_url(100,$id['id'].'NF',13);
	$cuerpo = '<br><br>Comentario: '.utf8_encode($mensaje);
	$cuerpo .= '<br><br>¿Has recibido la devolución económica de tu inscripción? Si pulsa en Si, se eliminará su inscripción en la liga '.$nombre_liga.' y división '.$num_division.'<br><br>';
