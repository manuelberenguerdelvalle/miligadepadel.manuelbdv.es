...
?>
	<div class="caja">
    	<div class="subcaja1">
            ...
            <div class="jugador1">
				...
				?>
						<div class="seguro" onMouseOver="showdiv(event,'- Seguro: <?php echo $seguro->getValor('licencia');?> - Validez: <?php echo datepicker_fecha($seguro->getValor('fecha_caducidad'));?> <br>- Federaci&oacute;n: <?php echo $seguro->getValor('federacion');?> <br>- Categor&iacute;a: <?php echo $seguro->getValor('categoria');?>.');" onMouseOut="hiddenDiv()" style="display:table;">+
                <?php
					}
					else{
    ...
    <?php } ?>
            ...
            <div class="jugador2">
				...
				?>
						<div class="seguro" onMouseOver="showdiv(event,'Seguro: <?php echo $seguro2->getValor('licencia');?> - Validez: <?php echo $seguro2->getValor('fecha_caducidad');?> - Federacin: <?php echo $seguro2->getValor('federacion');?> - Categora: <?php echo $seguro2->getValor('categoria');?>.');" onMouseOut="hiddenDiv()" style="display:table;">+
                <?php
					}
					else{
						echo '<div class="noseguro">&nbsp;';
