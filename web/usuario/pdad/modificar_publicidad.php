...
?>
    ...
    <div class="horizontal"><div class="titulo"><b>Importante:</b> Solo es posible modificar la dirección de las publicidades con el pago realizado correctamente.</div></div>
    <div class="horizontal">&nbsp;</div>
	<div class="caja1">
<?php
for($i=1; $i<=5; $i++){
