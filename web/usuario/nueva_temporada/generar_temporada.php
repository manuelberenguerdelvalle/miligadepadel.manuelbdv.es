...
<body>
    ...
    <div class="caja_pago">
        ...
        <label>
        	Esta Liga ha llegado a su fín, todas las divisiones se encuentran finalizadas en este momento, si lo desea puede generar una nueva temporada en la que se notificará a los jugadores si desean continuar con la Nueva Temporada actualizando las siguientes características:<br>-Ascensos/Descensos<br><br>Precios de Inscripción:
        </label>
        <div class="cuadroResultado">
            ...
            while($resultados = $consulta->fetch_array(MYSQLI_ASSOC)){
                echo '<div class="linea">División '.$resultados["num_division"].':&nbsp;<input type="text" class="input_precio" name="d'.$resultados["id_division"].'" id="'.$resultados["id_division"].'" value="'.$resultados["precio"].'" >&nbsp;&euro;</div>';
            }
            ?>
            </form>
        </div>
