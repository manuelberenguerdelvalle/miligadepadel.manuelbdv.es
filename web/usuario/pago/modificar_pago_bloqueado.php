...
if($consulta->num_rows > 0){
	...
	$consulta2 = $db2->consulta("SELECT * FROM pago_web WHERE usuario = '$id_usuario' AND liga = '".$resultados['id_liga']."' AND pagado = 'N' AND tipo = 'L' ORDER BY pagado,fecha; ");
	...
	<div class="caja"> 
    	<div class="datos">
        	<label class="datos_linea"><?php echo '<b>Liga:</b> '.substr($resultados['nombre'],0,30); if(strlen($resultados['nombre']) >= 30){echo '..';}?></label>
        ...
        <div class="datos2">
            ...
            <label class="datos_linea">
				<?php 
					echo '<b>Pack Liga '.obten_equipos($resultados['tipo_pago']).'</b>';
					$descrip_pago = 'Pack Liga Premium '.obten_equipos($resultados['tipo_pago']).': '.$resultados['nombre'];
                ?>
             </label>
        </div>
        <div class="datos3">
        	<?php //muestra_formulario($descrip_pago,$resultados2['id_pago_web'].rand(),$resultados2['precio'],'http://miligadepadel.manuelbdv.es/web/usuario/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/web/recibir_pagos/pago_web.php','manu_oamuf-facilitator@hotmail.com');
			//muestra_formulario($descrip_pago,$resultados2['id_pago_web'],$resultados2['precio'],'http://miligadepadel.manuelbdv.es/web/usuario/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/web/recibir_pagos/pago_web.php','manu_oamuf-facilitator@hotmail.com'); 
			muestra_formulario($descrip_pago,$resultados2['id_pago_web'],$resultados2['precio'],'http://miligadepadel.manuelbdv.es/web/usuario/pago/gestion_pago.php','http://miligadepadel.manuelbdv.es/web/recibir_pagos/pago_web.php',cuenta_admin()); 
			?>
        </div>  
	</div>
<?php
...
if($consulta->num_rows > 0){
	...
	<div class="caja"> 
    	<div class="datos">
        	<label class="datos_linea"><?php echo '<b>Liga:</b> '.substr($resultados['nombre'],0,30); if(strlen($resultados['nombre']) >= 30){echo '..';}?></label>
            <label class="datos_linea"><?php echo '<b>Division:</b> '.$resultados['num_division'];?></label> 
        </div>
        <div class="datos2">
        	<label class="datos_linea"><?php echo '<b>Fecha:</b> '.$fec_dia.'-'.$fec_mes.'-'.$fec_anyo;?></label>
            <label class="datos_linea">
        ...
        <div class="datos2">
            ...
            <label class="datos_linea">
				<?php 
					echo '<b>Divisin Extra</b>';
						$descrip_pago = 'Pack Divisin extra: n'.$resultados['num_division'].' en la liga '.$resultados['nombre'];
                ?>
             </label>
        </div>
        <div class="datos3">
