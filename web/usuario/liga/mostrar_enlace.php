...
<body>
    ...
    <div class="horizontal"><span style="color:#006;">Si desea añadir en su sitio web o blog su Liga de Padel puede hacerlo añadiendo el siguiente enlace en código html.<br>(Recomendable contactar con el responsable técnico de su web o blog).</span></div>
     <div class="horizontal">&nbsp;</div>
    <div class="caja">
	<?php
