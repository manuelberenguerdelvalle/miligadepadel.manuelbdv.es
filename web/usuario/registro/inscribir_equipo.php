        ...
        <div class="caja_jugador">
        	...
        	<div class="horizontal">
				...
				if( ($recibir_pago == 'O' || $recibir_pago == 'A')  && $precio > 0){
					...
					//muestra_formulario_sinboton($descrip_pago,$id_pago,0.5,'http://miligadepadel.manuelbdv.es/web/usuario/registro/pago.php','http://miligadepadel.manuelbdv.es/web/ep/pa.php',$cuenta_paypal);
					muestra_formulario_sinboton($descrip_pago,$id_pago,$precio,'http://miligadepadel.manuelbdv.es/web/usuario/registro/pago.php','http://miligadepadel.manuelbdv.es/web/ep/pa.php',$cuenta_paypal);
					//muestra_formulario_sinboton($descrip_pago,$id_pago,$precio,'http://miligadepadel.manuelbdv.es/web/usuario/registro/pago.php','http://miligadepadel.manuelbdv.es/web/ep/pa.php',cuenta_admin());	
					//muestra_formulario_sinboton($descrip_pago,$id_pago,$precio,'http://miligadepadel.manuelbdv.es/web/usuario/registro/pago.php','http://miligadepadel.manuelbdv.es/web/ep/pa.php','manu_oamuf-facilitator@hotmail.com');
