...
if ( isset($_POST['email']) ){//SI EXISTE POST
	...
	if($consulta->num_rows == 0){//SI NO EXISTE EL USUARIO LO REGISTRO
		...
		//$link = 'http://miligadepadel.manuelbdv.es/web/usuario/gestion_datos.php?id=MTIzNDU2Nzg5MA==';
		//$link = 'http://miligadepadel.manuelbdv.es/web/v/v/valida_registro.php?id=MTIzNDU2Nzg5MA==';
		//CAMBIAR A DINAMICO
		...
		$link = 'http://miligadepadel.manuelbdv.es/web/v/v/valida_registro.php?id='.$id;
